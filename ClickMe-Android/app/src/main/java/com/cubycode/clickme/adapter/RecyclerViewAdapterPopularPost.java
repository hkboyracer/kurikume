...
public class RecyclerViewAdapterPopularPost extends RecyclerView.Adapter<RecyclerViewAdapterPopularPost.FeedsViewHolder> {

    Context context;
    ArrayList<String> feedsList;

    public RecyclerViewAdapterPopularPost(Context context, ArrayList<String> feedsList) {
    ...
    public FeedsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View listItem= layoutInflater.inflate(R.layout.layout_custom_adapter_home_feeds, parent, false);
