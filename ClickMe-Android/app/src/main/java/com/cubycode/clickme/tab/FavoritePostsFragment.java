...
public class FavoritePostsFragment extends Fragment implements View.OnClickListener {
...
//                ViewModelProviders.of(this).get(NotificationsViewModel.class);
        View root = inflater.inflate(R.layout.fragment_profile_favorite_posts, container, false);
