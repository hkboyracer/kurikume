...
public class RecyclerViewAdapterMarketPlaceCategories extends RecyclerView.Adapter<RecyclerViewAdapterMarketPlaceCategories.TrendsViewHolder> {

    Context context;
    ArrayList<String> trendsList;

    public RecyclerViewAdapterMarketPlaceCategories(Context context, ArrayList<String> trendsList) {
...
//    }
    ...
    public TrendsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View listItem= layoutInflater.inflate(R.layout.layout_custom_adapter_marketplace_categories, parent, false);
