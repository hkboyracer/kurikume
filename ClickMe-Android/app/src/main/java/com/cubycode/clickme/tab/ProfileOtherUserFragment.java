...
public class ProfileOtherUserFragment extends Fragment implements View.OnClickListener {

    //    private NotificationsViewModel notificationsViewModel;
    private RecyclerView rvFeeds;
    RecyclerViewAdapterReplyNotifications recyclerViewAdapterPopularPost;
...
//                ViewModelProviders.of(this).get(NotificationsViewModel.class);
        View root = inflater.inflate(R.layout.fragment_profile_other_user, container, false);
...
//        });
    ...
    private void init(View view){
        rvFeeds = view.findViewById(R.id.rv_profile_other_user);
    }
    ...
    void setFeedsAdapter(Context context, ArrayList<String> feedsList){
        recyclerViewAdapterPopularPost = new RecyclerViewAdapterReplyNotifications(context,feedsList);
