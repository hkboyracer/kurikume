...
public class PopularPostFragment extends Fragment implements View.OnClickListener {
...
//                ViewModelProviders.of(this).get(NotificationsViewModel.class);
        View root = inflater.inflate(R.layout.fragment_popular_post, container, false);
...
//        });
    ...
    private void init(View view){
        rvFeeds = view.findViewById(R.id.rv_popular_post);
    }
