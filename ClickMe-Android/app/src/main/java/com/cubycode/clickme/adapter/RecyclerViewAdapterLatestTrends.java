...
public class RecyclerViewAdapterLatestTrends extends RecyclerView.Adapter<RecyclerViewAdapterLatestTrends.TrendsViewHolder> {

    Context context;
    ArrayList<String> trendsList;

    public RecyclerViewAdapterLatestTrends(Context context, ArrayList<String> trendsList) {
...
//    }
    ...
    public TrendsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View listItem= layoutInflater.inflate(R.layout.layout_custom_adapter_latest_trends, parent, false);
