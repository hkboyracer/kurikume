...
public class RecyclerViewAdapterReplyNotifications extends RecyclerView.Adapter<RecyclerViewAdapterReplyNotifications.HashTagsViewHolder> {

    Context context;
    ArrayList<String> notificationsList;

    public RecyclerViewAdapterReplyNotifications(Context context, ArrayList<String> feedsList) {
    ...
    public HashTagsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View listItem= layoutInflater.inflate(R.layout.layout_custom_adapter_reply_notifications, parent, false);
