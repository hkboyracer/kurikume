...
public class RecyclerViewAdapterBookmark extends RecyclerView.Adapter<RecyclerViewAdapterBookmark.FeedsViewHolder> {

    Context context;
    ArrayList<String> bookmarksList;

    public RecyclerViewAdapterBookmark(Context context, ArrayList<String> feedsList) {
        this.context = context;
        this.bookmarksList = feedsList;
    }
    ...
    public FeedsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View listItem= layoutInflater.inflate(R.layout.layout_custom_adapter_bookmark, parent, false);
