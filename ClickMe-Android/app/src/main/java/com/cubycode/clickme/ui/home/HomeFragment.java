package com.cubycode.clickme.ui.home;
...
import com.cubycode.clickme.adapter.RecyclerViewAdapterHomeFeeds;
...
public class HomeFragment extends Fragment implements View.OnClickListener {
    ...
    RecyclerViewAdapterHomeFeeds recyclerViewAdapterPopularPost;
...
//        });
        ...
        HomeActivity.tvHeaderHome.setText("");
        return root;
    }

    private void init(View view){
        rvFeeds = view.findViewById(R.id.rv_home_feeds);
    }
    ...
    void setFeedsAdapter(Context context, ArrayList<String> feedsList){
        recyclerViewAdapterPopularPost = new RecyclerViewAdapterHomeFeeds(context,feedsList);
