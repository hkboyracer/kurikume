...
public class RecyclerViewAdapterPopularUser extends RecyclerView.Adapter<RecyclerViewAdapterPopularUser.HashTagsViewHolder> {

    Context context;
    ArrayList<String> notificationsList;

    public RecyclerViewAdapterPopularUser(Context context, ArrayList<String> feedsList) {
    ...
    public HashTagsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View listItem= layoutInflater.inflate(R.layout.layoiut_custom_adapter_popular_user, parent, false);
