...
public class RecyclerViewAdapterHomeFeeds extends RecyclerView.Adapter<RecyclerViewAdapterHomeFeeds.FeedsViewHolder> {

    Context context;
    ArrayList<String> feedsList;

    public RecyclerViewAdapterHomeFeeds(Context context, ArrayList<String> feedsList) {
