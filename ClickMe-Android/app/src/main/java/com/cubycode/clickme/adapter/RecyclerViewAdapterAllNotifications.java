...
public class RecyclerViewAdapterAllNotifications extends RecyclerView.Adapter<RecyclerViewAdapterAllNotifications.HashTagsViewHolder> {

    Context context;
    ArrayList<String> notificationsList;

    public RecyclerViewAdapterAllNotifications(Context context, ArrayList<String> feedsList) {
    ...
    public HashTagsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View listItem= layoutInflater.inflate(R.layout.layoiut_custom_adapter_all_notifications, parent, false);
