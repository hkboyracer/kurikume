...
public class RecyclerViewAdapterMarketPlace extends RecyclerView.Adapter<RecyclerViewAdapterMarketPlace.FeedsViewHolder> {

    Context context;
    ArrayList<String> feedsList;

    public RecyclerViewAdapterMarketPlace(Context context, ArrayList<String> feedsList) {
    ...
    public FeedsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View listItem= layoutInflater.inflate(R.layout.layout_custom_adapter_marketplace, parent, false);
