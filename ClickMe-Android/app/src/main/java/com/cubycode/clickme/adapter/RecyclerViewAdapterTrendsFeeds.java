...
public class RecyclerViewAdapterTrendsFeeds extends RecyclerView.Adapter<RecyclerViewAdapterTrendsFeeds.FeedsViewHolder> {

    Context context;
    ArrayList<String> feedsList;

    public RecyclerViewAdapterTrendsFeeds(Context context, ArrayList<String> feedsList) {
